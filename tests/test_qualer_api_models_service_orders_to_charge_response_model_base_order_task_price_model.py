...
class TestQualerApiModelsServiceOrdersToChargeResponseModelBaseOrderTaskPriceModel(
    unittest.TestCase
):
    ...
    def testQualerApiModelsServiceOrdersToChargeResponseModelBaseOrderTaskPriceModel(
        self,
    ):
