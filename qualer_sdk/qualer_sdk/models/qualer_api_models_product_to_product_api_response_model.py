...
class QualerApiModelsProductToProductApiResponseModel(object):
    ...
    def __init__(self, product_id=None, parent_product_id=None, category_id=None, manufacturer_id=None, manufacturer_name=None, product_name=None, parent_product_name=None, manufacturer_part_number=None, product_description=None, is_family=None, is_discontinued=None, is_stock_item=None, unit_sale_price=None, supplier_information=None, quantity_on_hand=None, product_code=None, category_name=None, parent_category_name=None, _configuration=None):  # noqa: E501
