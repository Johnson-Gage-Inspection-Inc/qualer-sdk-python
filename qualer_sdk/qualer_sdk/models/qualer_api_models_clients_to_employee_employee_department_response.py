...
class QualerApiModelsClientsToEmployeeEmployeeDepartmentResponse(object):
    ...
    def __init__(self, id=None, name=None, position=None, _configuration=None):  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QualerApiModelsClientsToEmployeeEmployeeDepartmentResponse):
            return False
