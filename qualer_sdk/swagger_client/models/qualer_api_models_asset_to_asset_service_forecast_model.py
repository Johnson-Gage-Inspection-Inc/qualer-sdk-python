...
class QualerApiModelsAssetToAssetServiceForecastModel(object):
    ...
    def __init__(self, company_id=None, asset_id=None, site_id=None, asset_service_record_id=None, serial_number=None, asset_user=None, asset_tag=None, equipment_id=None, asset_name=None, category_name=None, manufacturer_name=None, site_name=None, maintenance_plan_id=None, maintenance_plan_name=None, maintenance_task_id=None, maintenance_task_name=None, next_service_date=None, advance_recall_date=None, grace_period_date=None, certificate_next_service_date=None, service_interval=None, interval_cycle=None, interval_length=None, on_day=None, on_month=None, on_week_days=None, weekday_of_month=None, advance_recall_period=None, days_before_due=None, past_due_grace_period=None, days_after_due=None, _configuration=None):  # noqa: E501
    ...
    def on_month(self, on_month):
        ...
        if (self._configuration.client_side_validation and
                on_month not in allowed_values):
            raise ValueError(
    ...
    def on_week_days(self, on_week_days):
        ...
        if (self._configuration.client_side_validation and
                on_week_days not in allowed_values):
            raise ValueError(
    ...
    def weekday_of_month(self, weekday_of_month):
        ...
        if (self._configuration.client_side_validation and
                weekday_of_month not in allowed_values):
            raise ValueError(
