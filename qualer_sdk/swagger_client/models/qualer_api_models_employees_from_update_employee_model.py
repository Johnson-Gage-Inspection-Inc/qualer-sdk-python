...
class QualerApiModelsEmployeesFromUpdateEmployeeModel(object):
    ...
    def __init__(self, first_name=None, last_name=None, subscription_email=None, mobile_phone=None, office_phone=None, alias=None, title=None, culture_name=None, culture_ui_name=None, image_url=None, _configuration=None):  # noqa: E501
