...
class QualerApiModelsMeasurementsToUpdateMeasurementToolResponseModel(object):
    ...
    def __init__(self, measurement_tool_id=None, last_service_date=None, next_service_date=None, calibrated_by=None, certificate_number=None, tool_name=None, tool_description=None, manufacturer=None, manufacturer_part_number=None, serial_number=None, asset_tag=None, asset_user=None, equipment_id=None, _configuration=None):  # noqa: E501
