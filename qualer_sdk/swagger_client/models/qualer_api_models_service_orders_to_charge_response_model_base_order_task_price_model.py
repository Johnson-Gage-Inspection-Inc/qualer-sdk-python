...
class QualerApiModelsServiceOrdersToChargeResponseModelBaseOrderTaskPriceModel(object):
    ...
    def __init__(self, contract_discount=None, time_spent=None, is_hourly=None, details=None, name=None, price=None, _configuration=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(QualerApiModelsServiceOrdersToChargeResponseModelBaseOrderTaskPriceModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QualerApiModelsServiceOrdersToChargeResponseModelBaseOrderTaskPriceModel):
            return False
