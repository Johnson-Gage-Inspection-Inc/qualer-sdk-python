...
class QualerApiModelsReportDatasetsToServiceOrderItemFieldResponse(object):
    ...
    def __init__(self, field_id=None, type=None, value=None, service_order_item_id=None, service_order_item_task_id=None, _configuration=None):  # noqa: E501
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["Int", "Double", "String", "Boolean", "Date", "List", "DateTime", "ValueLookup", "Text"]  # noqa: E501
