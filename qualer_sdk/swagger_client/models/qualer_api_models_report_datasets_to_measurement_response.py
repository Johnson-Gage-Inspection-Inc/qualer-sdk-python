...
class QualerApiModelsReportDatasetsToMeasurementResponse(object):
    ...
    def guard_band_logic(self, guard_band_logic):
        ...
        if (self._configuration.client_side_validation and
                guard_band_logic not in allowed_values):
            raise ValueError(
    ...
    def measurement_type(self, measurement_type):
        ...
        if (self._configuration.client_side_validation and
                measurement_type not in allowed_values):
            raise ValueError(
    ...
    def reading_entry_logic(self, reading_entry_logic):
        ...
        if (self._configuration.client_side_validation and
                reading_entry_logic not in allowed_values):
            raise ValueError(
    ...
    def reading_entry_math(self, reading_entry_math):
        ...
        if (self._configuration.client_side_validation and
                reading_entry_math not in allowed_values):
            raise ValueError(
    ...
    def double_substitution_sequence(self, double_substitution_sequence):
        ...
        if (self._configuration.client_side_validation and
                double_substitution_sequence not in allowed_values):
            raise ValueError(
    ...
    def environment_mask(self, environment_mask):
        ...
        if (self._configuration.client_side_validation and
                environment_mask not in allowed_values):
            raise ValueError(
    ...
    def tolerance_type(self, tolerance_type):
        ...
        if (self._configuration.client_side_validation and
                tolerance_type not in allowed_values):
            raise ValueError(
    ...
    def precision_type(self, precision_type):
        ...
        if (self._configuration.client_side_validation and
                precision_type not in allowed_values):
            raise ValueError(
    ...
    def measurement_not_taken_result(self, measurement_not_taken_result):
        ...
        if (self._configuration.client_side_validation and
                measurement_not_taken_result not in allowed_values):
            raise ValueError(
    ...
    def measurement_point_order(self, measurement_point_order):
        ...
        if (self._configuration.client_side_validation and
                measurement_point_order not in allowed_values):
            raise ValueError(
