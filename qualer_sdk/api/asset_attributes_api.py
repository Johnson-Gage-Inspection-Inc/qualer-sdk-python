...
class AssetAttributesApi(object):
    ...
    def asset_attributes_get_asset_attributes_with_http_info(self, asset_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/assets/{assetId}/attributes', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def asset_attributes_upsert_asset_attributes(self, body, asset_id, **kwargs):  # noqa: E501
        """asset_attributes_upsert_asset_attributes  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.asset_attributes_upsert_asset_attributes(body, asset_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.asset_attributes_upsert_asset_attributes_with_http_info(body, asset_id, **kwargs)  # noqa: E501
        else:
            (data) = self.asset_attributes_upsert_asset_attributes_with_http_info(body, asset_id, **kwargs)  # noqa: E501
            return data

    def asset_attributes_upsert_asset_attributes_with_http_info(self, body, asset_id, **kwargs):  # noqa: E501
        """asset_attributes_upsert_asset_attributes  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.asset_attributes_upsert_asset_attributes_with_http_info(body, asset_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `asset_attributes_upsert_asset_attributes`")  # noqa: E501
        # verify the required parameter 'asset_id' is set
        if ('asset_id' not in params or
                params['asset_id'] is None):
        ...
        return self.api_client.call_api(
            '/api/assets/{assetId}/attributes', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
