...
class QualerApiModelsMeasurementsFromCreateMeasurementSetModel(object):
    ...
    def __init__(self, measurement_name=None, is_accredited=None, measurement_quantity_id=None, default_unit_of_measure_id=None, decimal_places=None, significant_figures=None, display_options=None, custom_fields=None, measurement_points=None, _configuration=None):  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QualerApiModelsMeasurementsFromCreateMeasurementSetModel):
            return False
