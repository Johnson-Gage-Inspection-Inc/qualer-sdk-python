...
class QualerApiModelsServiceOrdersFromUpdatePaymentStatusModel(object):
    ...
    def __init__(self, payment_status=None, invoiced_on=None, _configuration=None):  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QualerApiModelsServiceOrdersFromUpdatePaymentStatusModel):
            return False
