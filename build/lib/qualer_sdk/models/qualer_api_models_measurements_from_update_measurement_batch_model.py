...
class QualerApiModelsMeasurementsFromUpdateMeasurementBatchModel(object):
    ...
    def __init__(self, batch_id=None, batch_type=None, save_and_delete_empty=None, measurement_sets=None, _configuration=None):  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QualerApiModelsMeasurementsFromUpdateMeasurementBatchModel):
            return False
