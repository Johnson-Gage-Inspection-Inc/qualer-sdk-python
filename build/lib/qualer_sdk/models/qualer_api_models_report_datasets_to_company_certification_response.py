...
class QualerApiModelsReportDatasetsToCompanyCertificationResponse(object):
    ...
    def __init__(self, logo=None, initial_date=None, certification_date=None, expiration_date=None, certification_name=None, certificate_number=None, certification_authority=None, certification_standard=None, _configuration=None):  # noqa: E501
    ...
    def logo(self, logo):
        ...
        if (self._configuration.client_side_validation and
                logo is not None and not re.search(r'^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$', logo)):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(QualerApiModelsReportDatasetsToCompanyCertificationResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QualerApiModelsReportDatasetsToCompanyCertificationResponse):
            return False
