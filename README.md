...
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/Johnson-Gage-Inspection-Inc/qualer-sdk-python.git`)
...
### Windows Users: Long Path Support

If you're on Windows and encounter errors like:
...
You need to enable long path support in Git. Run this command:

```sh
git config --global core.longpaths true
```

This allows Git to handle paths longer than 260 characters, which is necessary due to some long auto-generated filenames in this SDK.
...
body = qualer_sdk.QualerWebMvcAreasApiModelsAccountToLoginModel() # QualerWebMvcAreasApiModelsAccountToLoginModel | 
...
# create an instance of the API class
api_instance = qualer_sdk.AccountApi(qualer_sdk.ApiClient(configuration))
body = qualer_sdk.QualerApiModelsAccountToLogoutModel() # QualerApiModelsAccountToLogoutModel | 
...
# create an instance of the API class
api_instance = qualer_sdk.AccountApi(qualer_sdk.ApiClient(configuration))
body = qualer_sdk.QualerApiModelsEmployeesFromEmployeeLocationModel() # QualerApiModelsEmployeesFromEmployeeLocationModel | 
