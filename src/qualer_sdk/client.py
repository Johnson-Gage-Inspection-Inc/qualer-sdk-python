# Template for client.py with Api-Token as default prefix
# This template is used instead of post-processing the generated client.py
# to ensure a more robust and maintainable approach for setting the default
# authorization prefix to "Api-Token" instead of "Bearer".
import ssl
...
@define
class Client:
    """A Client which sends requests to the API without authentication.
