...
from qualer_sdk.api_response import T as ApiResponseT
from qualer_sdk.configuration import Configuration
from qualer_sdk.exceptions import ApiException, ApiValueError
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(qualer_sdk.models, klass)
