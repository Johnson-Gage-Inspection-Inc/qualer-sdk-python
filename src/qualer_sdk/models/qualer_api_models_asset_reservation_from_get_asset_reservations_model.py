...
class QualerApiModelsAssetReservationFromGetAssetReservationsModel(BaseModel):
    ...
    def from_json(
        ...
        """Create an instance of QualerApiModelsAssetReservationFromGetAssetReservationsModel from a JSON string"""
    ...
    def from_dict(
        ...
        """Create an instance of QualerApiModelsAssetReservationFromGetAssetReservationsModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return (
                QualerApiModelsAssetReservationFromGetAssetReservationsModel.parse_obj(
                    obj
                )
            )

        _obj = QualerApiModelsAssetReservationFromGetAssetReservationsModel.parse_obj(
            {
