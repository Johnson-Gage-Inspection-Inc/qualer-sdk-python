...
class QualerApiModelsMeasurementsFromDisplayOptions(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualerApiModelsMeasurementsFromDisplayOptions:
    ...
    def from_dict(cls, obj: dict) -> QualerApiModelsMeasurementsFromDisplayOptions:
        ...
        if not isinstance(obj, dict):
            return QualerApiModelsMeasurementsFromDisplayOptions.parse_obj(obj)

        _obj = QualerApiModelsMeasurementsFromDisplayOptions.parse_obj(
            {
                "err": obj.get("Err"),
                "mean": obj.get("Mean"),
                "max": obj.get("Max"),
