...
class QualerApiModelsMaintenancePlansToMaintenanceTaskResponse(object):
    ...
    def __init__(
        ...
        as_found_standard_group_id=None,
        as_left_standard_group_id=None,
        task_notes=None,
        advance_recall_period=None,
        days_before_due=None,
        past_due_grace_period=None,
        days_after_due=None,
        use_period_in_reports=None,
        generate_order_automatically=None,
        approve_upon_generation=None,
        generate_separate=None,
        _configuration=None,
    ):  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(
            other, QualerApiModelsMaintenancePlansToMaintenanceTaskResponse
        ):
            return False
