...
class QualerApiModelsAssetServiceRecordsFromUpdateAssetServiceRecordModel(BaseModel):
    ...
    def from_dict(
        ...
        if not isinstance(obj, dict):
            return QualerApiModelsAssetServiceRecordsFromUpdateAssetServiceRecordModel.parse_obj(
                obj
            )

        _obj = QualerApiModelsAssetServiceRecordsFromUpdateAssetServiceRecordModel.parse_obj(
            {
