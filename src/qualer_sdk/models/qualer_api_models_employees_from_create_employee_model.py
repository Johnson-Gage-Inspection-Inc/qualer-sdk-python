...
class QualerApiModelsEmployeesFromCreateEmployeeModel(BaseModel):
    """
    ...
    def from_json(
        ...
        """Create an instance of QualerApiModelsEmployeesFromCreateEmployeeModel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualerApiModelsEmployeesFromCreateEmployeeModel:
        """Create an instance of QualerApiModelsEmployeesFromCreateEmployeeModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QualerApiModelsEmployeesFromCreateEmployeeModel.parse_obj(obj)

        _obj = QualerApiModelsEmployeesFromCreateEmployeeModel.parse_obj(
            {
