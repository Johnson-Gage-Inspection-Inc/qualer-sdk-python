...
class QualerApiModelsAssetToClientAssetCountersResponseModel(object):
    ...
    def __init__(
        self,
        client_assets_collected=None,
        client_unset=None,
        client_due_for_service=None,
        client_past_due=None,
        client_out_of_service=None,
        client_without_schedule=None,
        _configuration=None,
    ):  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(
            other, QualerApiModelsAssetToClientAssetCountersResponseModel
        ):
            return False
