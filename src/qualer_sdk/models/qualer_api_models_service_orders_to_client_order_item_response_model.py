...
class QualerApiModelsServiceOrdersToClientOrderItemResponseModel:
    ...
    Attributes:
        ...
        item_result_status (Union[Unset, str]):
        item_as_found_result (Union[Unset, str]):
        item_as_left_result (Union[Unset, str]):
        as_found_specification (Union[Unset, int]):
        as_left_specification (Union[Unset, int]):
        ...
        service_level_document_number (Union[Unset, str]):
        service_level_document_section (Union[Unset, str]):
        ...
        asset_site_name (Union[Unset, str]):
        asset_site_id (Union[Unset, int]):
        asset_company_name (Union[Unset, str]):
        asset_company_id (Union[Unset, int]):
        ...
        maintenance_plan (Union[Unset, str]):
    ...
    item_result_status: Union[Unset, str] = UNSET
    item_as_found_result: Union[Unset, str] = UNSET
    item_as_left_result: Union[Unset, str] = UNSET
    as_found_specification: Union[Unset, int] = UNSET
    as_left_specification: Union[Unset, int] = UNSET
    ...
    service_level_document_number: Union[Unset, str] = UNSET
    service_level_document_section: Union[Unset, str] = UNSET
    ...
    asset_site_name: Union[Unset, str] = UNSET
    asset_site_id: Union[Unset, int] = UNSET
    asset_company_name: Union[Unset, str] = UNSET
    asset_company_id: Union[Unset, int] = UNSET
    ...
    maintenance_plan: Union[Unset, str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        item_result_status = d.pop("ItemResultStatus", UNSET)

        item_as_found_result = d.pop("ItemAsFoundResult", UNSET)

        item_as_left_result = d.pop("ItemAsLeftResult", UNSET)

        as_found_specification = d.pop("AsFoundSpecification", UNSET)

        as_left_specification = d.pop("AsLeftSpecification", UNSET)
        ...
        service_level_document_number = d.pop("ServiceLevelDocumentNumber", UNSET)

        service_level_document_section = d.pop("ServiceLevelDocumentSection", UNSET)
        ...
        asset_site_name = d.pop("AssetSiteName", UNSET)

        asset_site_id = d.pop("AssetSiteId", UNSET)

        asset_company_name = d.pop("AssetCompanyName", UNSET)

        asset_company_id = d.pop("AssetCompanyId", UNSET)
        ...
        maintenance_plan = d.pop("MaintenancePlan", UNSET)
