...
T = TypeVar(
    "T", bound="QualerApiModelsClientsToClientCompanyResponseModelShippingAddressType0"
)
...
class QualerApiModelsClientsToClientCompanyResponseModelShippingAddressType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        qualer_api_models_clients_to_client_company_response_model_shipping_address_type_0 = (
            cls()
        )
