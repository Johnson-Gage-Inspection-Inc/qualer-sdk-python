...
class QualerApiModelsAssetToAssetResponseModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualerApiModelsAssetToAssetResponseModel:
        """Create an instance of QualerApiModelsAssetToAssetResponseModel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualerApiModelsAssetToAssetResponseModel:
        """Create an instance of QualerApiModelsAssetToAssetResponseModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QualerApiModelsAssetToAssetResponseModel.parse_obj(obj)

        _obj = QualerApiModelsAssetToAssetResponseModel.parse_obj(
            {
