...
class QualerApiModelsAssetToAssetsCountResponseModel(object):
    ...
    def __init__(
        self,
        assets_all=None,
        assets_collected=None,
        assets_recently_serviced=None,
        assets_due=None,
        assets_past_due=None,
        assets_service_pending=None,
        assets_recently_purchased=None,
        assets_warranty_expires=None,
        assets_due_for_replacement=None,
        assets_out_of_service=None,
        assets_not_serviced=None,
        assets_without_schedule=None,
        assets_without_vendor=None,
        assets_without_product=None,
        assets_added=None,
        assets_updated=None,
        assets_deleted=None,
        assets_no_agreement=None,
        assets_expired_agreement=None,
        assets_expiring_soon_agreement=None,
        _configuration=None,
    ):  # noqa: E501
