...
class QualerApiModelsInventoryToInventoryResponseModel(BaseModel):
    ...
    def from_json(
        ...
        """Create an instance of QualerApiModelsInventoryToInventoryResponseModel from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> QualerApiModelsInventoryToInventoryResponseModel:
        """Create an instance of QualerApiModelsInventoryToInventoryResponseModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QualerApiModelsInventoryToInventoryResponseModel.parse_obj(obj)

        _obj = QualerApiModelsInventoryToInventoryResponseModel.parse_obj(
            {
