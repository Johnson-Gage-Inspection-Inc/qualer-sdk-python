...
class QualerApiModelsReferenceToUnitOfMeasureResponse(BaseModel):
    ...
    def from_json(
        ...
        """Create an instance of QualerApiModelsReferenceToUnitOfMeasureResponse from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> QualerApiModelsReferenceToUnitOfMeasureResponse:
        """Create an instance of QualerApiModelsReferenceToUnitOfMeasureResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QualerApiModelsReferenceToUnitOfMeasureResponse.parse_obj(obj)

        _obj = QualerApiModelsReferenceToUnitOfMeasureResponse.parse_obj(
            {
