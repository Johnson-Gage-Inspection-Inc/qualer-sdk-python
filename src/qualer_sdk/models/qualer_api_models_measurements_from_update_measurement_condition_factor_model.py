...
class QualerApiModelsMeasurementsFromUpdateMeasurementConditionFactorModel(BaseModel):
    ...
    def from_dict(
        ...
        if not isinstance(obj, dict):
            return QualerApiModelsMeasurementsFromUpdateMeasurementConditionFactorModel.parse_obj(
                obj
            )

        _obj = QualerApiModelsMeasurementsFromUpdateMeasurementConditionFactorModel.parse_obj(
            {
