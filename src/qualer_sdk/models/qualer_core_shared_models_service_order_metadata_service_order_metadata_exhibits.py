...
class QualerCoreSharedModelsServiceOrderMetadataServiceOrderMetadataExhibits(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["Title", "Subtitle", "Exhibits"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.exhibits:
            for _item_exhibits in self.exhibits:
                if _item_exhibits:
                    _items.append(_item_exhibits.to_dict())
