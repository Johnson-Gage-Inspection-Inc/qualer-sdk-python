...
class QualerApiModelsMeasurementsToUpdateMeasurementToolResponseModel(BaseModel):
    ...
    def from_json(
        ...
        """Create an instance of QualerApiModelsMeasurementsToUpdateMeasurementToolResponseModel from a JSON string"""
    ...
    def from_dict(
        ...
        """Create an instance of QualerApiModelsMeasurementsToUpdateMeasurementToolResponseModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QualerApiModelsMeasurementsToUpdateMeasurementToolResponseModel.parse_obj(
                obj
            )

        _obj = (
            QualerApiModelsMeasurementsToUpdateMeasurementToolResponseModel.parse_obj(
                {
