...
class QualerApiModelsAssetToClientAssetManagerResponseModel:
    ...
    Attributes:
        ...
        result_status (Union[Unset, QualerApiModelsAssetToClientAssetManagerResponseModelResultStatus]):
        as_found_result (Union[Unset, QualerApiModelsAssetToClientAssetManagerResponseModelAsFoundResult]):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if asset_collection_id is not UNSET:
        ...
        if in_service is not UNSET:
            field_dict["InService"] = in_service
        if in_last_service is not UNSET:
        ...
        if service_site_name is not UNSET:
            field_dict["ServiceSiteName"] = service_site_name
        if service_site_id is not UNSET:
            field_dict["ServiceSiteId"] = service_site_id
        if standard_title is not UNSET:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        asset_collection_id = d.pop("AssetCollectionId", UNSET)
        ...
        in_service = d.pop("InService", UNSET)

        in_last_service = d.pop("InLastService", UNSET)
        ...
        service_site_name = d.pop("ServiceSiteName", UNSET)

        service_site_id = d.pop("ServiceSiteId", UNSET)

        standard_title = d.pop("StandardTitle", UNSET)
        ...
        qualer_api_models_asset_to_client_asset_manager_response_model.additional_properties = (
            d
        )
