...
class QualerApiModelsAssetToClientAssetManagerResponseModel(BaseModel):
    ...
    asset_collection_id: Optional[StrictInt] = Field(None, alias="AssetCollectionId")
    ...
    in_service: Optional[StrictBool] = Field(None, alias="InService")
    in_last_service: Optional[StrictBool] = Field(None, alias="InLastService")
    ...
    service_tag: Optional[StrictStr] = Field(None, alias="ServiceTag")
    service_site_name: Optional[StrictStr] = Field(None, alias="ServiceSiteName")
    service_site_id: Optional[StrictInt] = Field(None, alias="ServiceSiteId")
    standard_title: Optional[StrictStr] = Field(None, alias="StandardTitle")
    schedules: Optional[StrictStr] = Field(None, alias="Schedules")
    __properties = [
        "AssetId",
        "AssetName",
        "AssetDescription",
    ...
    def record_type_validate_enum(cls, value):
        ...
        if value not in ("WaitingForAgreement", "Equipment", "System", "Agreement"):
            raise ValueError(
    ...
    def from_dict(
        ...
        if not isinstance(obj, dict):
            return QualerApiModelsAssetToClientAssetManagerResponseModel.parse_obj(obj)

        _obj = QualerApiModelsAssetToClientAssetManagerResponseModel.parse_obj(
            {
                ...
                "asset_collection_id": obj.get("AssetCollectionId"),
                ...
                "in_service": obj.get("InService"),
                "in_last_service": obj.get("InLastService"),
                ...
                "service_tag": obj.get("ServiceTag"),
                "service_site_name": obj.get("ServiceSiteName"),
                "service_site_id": obj.get("ServiceSiteId"),
                "standard_title": obj.get("StandardTitle"),
