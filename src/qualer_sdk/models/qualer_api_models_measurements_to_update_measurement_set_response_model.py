...
class QualerApiModelsMeasurementsToUpdateMeasurementSetResponseModel(BaseModel):
    ...
    measurement_points: Optional[
        conlist(QualerApiModelsMeasurementsToUpdateMeasurementPointResponseModel)
    ] = Field(None, alias="MeasurementPoints")
    measurement_fields: Optional[
        conlist(QualerApiModelsMeasurementsToUpdateMeasurementFieldResponseModel)
    ...
    def from_json(
        ...
        """Create an instance of QualerApiModelsMeasurementsToUpdateMeasurementSetResponseModel from a JSON string"""
    ...
    def from_dict(
        ...
        """Create an instance of QualerApiModelsMeasurementsToUpdateMeasurementSetResponseModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QualerApiModelsMeasurementsToUpdateMeasurementSetResponseModel.parse_obj(
                obj
            )

        _obj = QualerApiModelsMeasurementsToUpdateMeasurementSetResponseModel.parse_obj(
            {
