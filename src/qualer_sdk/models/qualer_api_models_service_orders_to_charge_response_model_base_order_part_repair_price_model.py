...
class QualerApiModelsServiceOrdersToChargeResponseModelBaseOrderPartRepairPriceModel(
    ...
    def from_dict(
        ...
        if not isinstance(obj, dict):
            return QualerApiModelsServiceOrdersToChargeResponseModelBaseOrderPartRepairPriceModel.parse_obj(
                obj
            )

        _obj = QualerApiModelsServiceOrdersToChargeResponseModelBaseOrderPartRepairPriceModel.parse_obj(
            {
