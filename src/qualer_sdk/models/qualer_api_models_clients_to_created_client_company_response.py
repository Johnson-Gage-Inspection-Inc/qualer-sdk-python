...
T = TypeVar("T", bound="QualerApiModelsClientsToCreatedClientCompanyResponse")
...
class QualerApiModelsClientsToCreatedClientCompanyResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        qualer_api_models_clients_to_created_client_company_response.additional_properties = (
            d
        )
