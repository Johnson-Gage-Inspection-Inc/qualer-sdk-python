...
class QualerApiModelsReportDatasetsToMeasurementChartResponse(object):
    ...
    def chart_image(self, chart_image):
        ...
        if (
            ...
            raise ValueError(
                r"Invalid value for `chart_image`, must be a follow pattern or equal to `/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/`"
            )  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(
            other, QualerApiModelsReportDatasetsToMeasurementChartResponse
        ):
            return False
