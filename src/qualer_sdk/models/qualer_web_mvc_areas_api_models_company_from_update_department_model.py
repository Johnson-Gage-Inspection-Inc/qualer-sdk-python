...
T = TypeVar("T", bound="QualerWebMvcAreasApiModelsCompanyFromUpdateDepartmentModel")
...
class QualerWebMvcAreasApiModelsCompanyFromUpdateDepartmentModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        return qualer_web_mvc_areas_api_models_company_from_update_department_model
