...
class QualerApiModelsServiceOrderDocumentsToCompanyOrderControlledDocumentResponse(
    ...
    def from_dict(
        ...
        if not isinstance(obj, dict):
            return QualerApiModelsServiceOrderDocumentsToCompanyOrderControlledDocumentResponse.parse_obj(
                obj
            )

        _obj = QualerApiModelsServiceOrderDocumentsToCompanyOrderControlledDocumentResponse.parse_obj(
            {
