...
class QualerApiModelsReportDatasetsToServiceOrderItemOptionResponse(BaseModel):
    ...
    def from_json(
        ...
        """Create an instance of QualerApiModelsReportDatasetsToServiceOrderItemOptionResponse from a JSON string"""
    ...
    def from_dict(
        ...
        """Create an instance of QualerApiModelsReportDatasetsToServiceOrderItemOptionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return (
                QualerApiModelsReportDatasetsToServiceOrderItemOptionResponse.parse_obj(
                    obj
                )
            )

        _obj = QualerApiModelsReportDatasetsToServiceOrderItemOptionResponse.parse_obj(
            {
