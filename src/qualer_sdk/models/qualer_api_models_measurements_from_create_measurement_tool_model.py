...
class QualerApiModelsMeasurementsFromCreateMeasurementToolModel(BaseModel):
    """
    ...
    def from_json(
        ...
        """Create an instance of QualerApiModelsMeasurementsFromCreateMeasurementToolModel from a JSON string"""
    ...
    def from_dict(
        ...
        """Create an instance of QualerApiModelsMeasurementsFromCreateMeasurementToolModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QualerApiModelsMeasurementsFromCreateMeasurementToolModel.parse_obj(
                obj
            )

        _obj = QualerApiModelsMeasurementsFromCreateMeasurementToolModel.parse_obj(
            {
