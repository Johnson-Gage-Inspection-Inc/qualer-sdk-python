...
class QualerApiModelsReportDatasetsToServiceOrderItemFieldResponse(object):
    ...
    def __init__(
        ...
        service_order_item_task_id=None,
        _configuration=None,
    ):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(
            QualerApiModelsReportDatasetsToServiceOrderItemFieldResponse, dict
        ):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(
            other, QualerApiModelsReportDatasetsToServiceOrderItemFieldResponse
        ):
            return False
