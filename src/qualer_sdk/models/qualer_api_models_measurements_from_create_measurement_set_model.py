...
class QualerApiModelsMeasurementsFromCreateMeasurementSetModel(BaseModel):
    ...
    display_options: Optional[QualerApiModelsMeasurementsFromDisplayOptions] = Field(
        None, alias="DisplayOptions"
    )
    custom_fields: Optional[QualerApiModelsMeasurementsFromCustomFields] = Field(
        None, alias="CustomFields"
    )
    measurement_points: Optional[
        conlist(QualerApiModelsMeasurementsFromCreateMeasurementPointModel)
    ...
    def from_dict(
        ...
        if not isinstance(obj, dict):
            return QualerApiModelsMeasurementsFromCreateMeasurementSetModel.parse_obj(
                obj
            )

        _obj = QualerApiModelsMeasurementsFromCreateMeasurementSetModel.parse_obj(
            {
