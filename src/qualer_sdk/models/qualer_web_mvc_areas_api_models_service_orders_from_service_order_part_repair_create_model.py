...
class QualerWebMvcAreasApiModelsServiceOrdersFromServiceOrderPartRepairCreateModel(
    ...
    def from_json(
        ...
        """Create an instance of QualerWebMvcAreasApiModelsServiceOrdersFromServiceOrderPartRepairCreateModel from a JSON string"""
    ...
    def from_dict(
        ...
        """Create an instance of QualerWebMvcAreasApiModelsServiceOrdersFromServiceOrderPartRepairCreateModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QualerWebMvcAreasApiModelsServiceOrdersFromServiceOrderPartRepairCreateModel.parse_obj(
                obj
            )

        _obj = QualerWebMvcAreasApiModelsServiceOrdersFromServiceOrderPartRepairCreateModel.parse_obj(
            {
                "name": obj.get("Name"),
