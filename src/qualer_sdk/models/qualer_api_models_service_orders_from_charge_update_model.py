...
class QualerApiModelsServiceOrdersFromChargeUpdateModel(BaseModel):
    ...
    charges: Optional[
        conlist(QualerApiModelsServiceOrdersFromChargeUpdateModelPriceModel)
    ...
    def from_dict(cls, obj: dict) -> QualerApiModelsServiceOrdersFromChargeUpdateModel:
        ...
        if not isinstance(obj, dict):
            return QualerApiModelsServiceOrdersFromChargeUpdateModel.parse_obj(obj)

        _obj = QualerApiModelsServiceOrdersFromChargeUpdateModel.parse_obj(
            {
                "charges": (
                    [
