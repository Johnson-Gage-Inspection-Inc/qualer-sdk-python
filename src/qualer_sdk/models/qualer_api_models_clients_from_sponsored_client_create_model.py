...
class QualerApiModelsClientsFromSponsoredClientCreateModel(BaseModel):
    ...
    def client_status_validate_enum(cls, value):
        ...
        if value not in set(["Prospect", "Approved", "NotApproved", "Hidden"]):
            raise ValueError(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QualerApiModelsClientsFromSponsoredClientCreateModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QualerApiModelsClientsFromSponsoredClientCreateModel from a dict"""
        if obj is None:
            return None
