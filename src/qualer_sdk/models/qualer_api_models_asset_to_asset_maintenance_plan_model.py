...
class QualerApiModelsAssetToAssetMaintenancePlanModel(BaseModel):
    ...
    maintenance_plans: Optional[
        conlist(QualerApiModelsAssetToAssetMaintenancePlanResponse)
    ] = Field(None, alias="MaintenancePlans")
    ...
    def to_dict(self):
        ...
        if self.maintenance_plans:
            for _item in self.maintenance_plans:
                if _item:
    ...
    def from_dict(cls, obj: dict) -> QualerApiModelsAssetToAssetMaintenancePlanModel:
        ...
        if not isinstance(obj, dict):
            return QualerApiModelsAssetToAssetMaintenancePlanModel.parse_obj(obj)

        _obj = QualerApiModelsAssetToAssetMaintenancePlanModel.parse_obj(
            {
                "maintenance_plans": (
                    [
                        ...
                        for _item in obj.get("MaintenancePlans")
                    ]
