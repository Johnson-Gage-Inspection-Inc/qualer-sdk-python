...
class QualerApiModelsServiceOrderDocumentsFromUploadDocumentsModel(object):
    ...
    """
    swagger_types = {"report_type": "str", "is_private": "bool"}

    attribute_map = {"report_type": "ReportType", "is_private": "IsPrivate"}

    def __init__(
        self, report_type=None, is_private=None, _configuration=None
    ):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(
            QualerApiModelsServiceOrderDocumentsFromUploadDocumentsModel, dict
        ):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(
            other, QualerApiModelsServiceOrderDocumentsFromUploadDocumentsModel
        ):
            return False
