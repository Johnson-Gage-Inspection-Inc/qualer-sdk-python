...
class QualerApiModelsVendorsFromSponsoredVendorEditModel(BaseModel):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualerApiModelsVendorsFromSponsoredVendorEditModel:
        """Create an instance of QualerApiModelsVendorsFromSponsoredVendorEditModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QualerApiModelsVendorsFromSponsoredVendorEditModel.parse_obj(obj)

        _obj = QualerApiModelsVendorsFromSponsoredVendorEditModel.parse_obj(
            {
