...
class QualerApiModelsVendorsFromSponsoredVendorEditModel(BaseModel):
    ...
    custom_vendor_name: Optional[StrictStr] = Field(
        default=None, alias="CustomVendorName"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QualerApiModelsVendorsFromSponsoredVendorEditModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QualerApiModelsVendorsFromSponsoredVendorEditModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "CustomVendorName": obj.get("CustomVendorName"),
