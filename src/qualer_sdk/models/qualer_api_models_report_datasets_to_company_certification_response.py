...
class QualerApiModelsReportDatasetsToCompanyCertificationResponse(BaseModel):
    ...
    ] = Field(default=None, alias="Logo")
    initial_date: Optional[datetime] = Field(default=None, alias="InitialDate")
    certification_date: Optional[datetime] = Field(
        default=None, alias="CertificationDate"
    )
    expiration_date: Optional[datetime] = Field(default=None, alias="ExpirationDate")
    certification_name: Optional[StrictStr] = Field(
        default=None, alias="CertificationName"
    )
    ...
    certification_authority: Optional[StrictStr] = Field(
        default=None, alias="CertificationAuthority"
    )
    certification_standard: Optional[StrictStr] = Field(
        default=None, alias="CertificationStandard"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "CertificationDate": obj.get("CertificationDate"),
                ...
                "CertificationStandard": obj.get("CertificationStandard"),
            }
        )
        return _obj
