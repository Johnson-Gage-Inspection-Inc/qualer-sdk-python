...
class QualerApiModelsMeasurementsToMeasurementRecordResponseModelMeasurementBatchResponseModel(
    ...
    specification: Optional[
        QualerApiModelsMeasurementsToMeasurementRecordResponseModelSpecificationResponseModel
    ] = Field(None, alias="Specification")
    ...
    def from_dict(
        ...
        if not isinstance(obj, dict):
            return QualerApiModelsMeasurementsToMeasurementRecordResponseModelMeasurementBatchResponseModel.parse_obj(
                obj
            )

        _obj = QualerApiModelsMeasurementsToMeasurementRecordResponseModelMeasurementBatchResponseModel.parse_obj(
            {
