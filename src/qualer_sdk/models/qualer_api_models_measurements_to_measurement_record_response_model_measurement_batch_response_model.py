...
class QualerApiModelsMeasurementsToMeasurementRecordResponseModelMeasurementBatchResponseModel(
    ...
    batch_result: Optional[StrictStr] = Field(default=None, alias="BatchResult")
    specification: Optional[
        QualerApiModelsMeasurementsToMeasurementRecordResponseModelSpecificationResponseModel
    ] = Field(default=None, alias="Specification")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QualerApiModelsMeasurementsToMeasurementRecordResponseModelMeasurementBatchResponseModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QualerApiModelsMeasurementsToMeasurementRecordResponseModelMeasurementBatchResponseModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "Specification": (
                    QualerApiModelsMeasurementsToMeasurementRecordResponseModelSpecificationResponseModel.from_dict(
                        obj["Specification"]
                    )
                ...
                "MeasurementSets": (
                    [
                        QualerApiModelsMeasurementsToMeasurementRecordResponseModelMeasurementBatchResponseModelMeasurementSetResponseModel.from_dict(
                            _item
                        )
