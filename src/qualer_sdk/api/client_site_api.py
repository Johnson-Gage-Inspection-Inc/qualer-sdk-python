...
class ClientSiteApi(object):
    ...
    def create_client_site(
        self,
        client_company_id: Annotated[
            StrictInt, Field(..., description="Client Company Id")
        ],
        model: Annotated[
            QualerApiModelsSiteFromSiteCreateModel,
            Field(..., description="Site create model"),
        ],
        **kwargs,
    ) -> object:  # noqa: E501
        ...
        :param client_company_id: Client Company Id (required)
        :type client_company_id: int
        :param model: Site create model (required)
        :type model: QualerApiModelsSiteFromSiteCreateModel
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the create_client_site_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
    ...
    def create_client_site_with_http_info(
        ...
        **kwargs,
        ...
        _all_params = ["client_company_id", "model"]
        _all_params.extend(
            [
                "async_req",
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_client_site" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def get_client_sites(
    ...
    ) -> List[QualerApiModelsSiteToClientSiteResponse]:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: List[QualerApiModelsSiteToClientSiteResponse]
        """
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_client_sites_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
    ...
    def get_client_sites_with_http_info(
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(List[QualerApiModelsSiteToClientSiteResponse], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_client_sites" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        _response_types_map = {
            "200": "List[QualerApiModelsSiteToClientSiteResponse]",
        }
    ...
    def update_client_site(
        ...
        model: Annotated[
            QualerApiModelsSiteFromSiteUpdateModel,
            Field(..., description="Site update model"),
        ],
        **kwargs,
    ) -> object:  # noqa: E501
        ...
        :param client_company_id: Client Company Id (required)
        :type client_company_id: int
        :param model: Site update model (required)
        :type model: QualerApiModelsSiteFromSiteUpdateModel
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the update_client_site_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_client_site" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
