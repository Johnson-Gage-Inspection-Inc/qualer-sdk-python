...
class ServiceOrderItemDocumentsApi(object):
    ...
    def get_document_list_with_http_info(self, _from, to, **kwargs):  # noqa: E501
        ...
        if "service_order_item_id" in params:
            query_params.append(
                ("serviceOrderItemId", params["service_order_item_id"])
            )  # noqa: E501
    ...
    def get_documents_with_http_info(
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `service_order_item_id` when calling `get_documents`"
            )  # noqa: E501
    ...
    def get_documents_list_with_http_info(
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `service_order_item_id` when calling `get_documents_list`"
            )  # noqa: E501
    ...
    def upload_documents_with_http_info(
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `service_order_item_id` when calling `upload_documents`"
            )  # noqa: E501
