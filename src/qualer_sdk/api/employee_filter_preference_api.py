...
class EmployeeFilterPreferenceApi(object):
    ...
    def get_employee_filter_preferences(
        ...
        :rtype: List[QualerApiModelsAssetToEmployeeFilterPreferenceResponseModel]
        """
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_employee_filter_preferences_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.get_employee_filter_preferences_with_http_info(
            **kwargs
        )  # noqa: E501
    ...
    def get_employee_filter_preferences_with_http_info(
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(List[QualerApiModelsAssetToEmployeeFilterPreferenceResponseModel], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_employee_filter_preferences" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def update_employee_filter_preference(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the update_employee_filter_preference_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.update_employee_filter_preference_with_http_info(
            model, **kwargs
        )  # noqa: E501
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_employee_filter_preference" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
