...
class ClientAssetServiceRecordsApi(object):
    ...
    def get_asset_service_records_by_asset_get2(
        ...
        """get_asset_service_records_by_asset_get2  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_asset_service_records_by_asset_get2(asset_id, async_req=True)
        >>> result = thread.get()
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_asset_service_records_by_asset_get2_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.get_asset_service_records_by_asset_get2_with_http_info(
            asset_id, **kwargs
        )  # noqa: E501
    ...
    def get_asset_service_records_by_asset_get2_with_http_info(
        ...
        >>> thread = api.get_asset_service_records_by_asset_get2_with_http_info(asset_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_asset_service_records_by_asset_get2" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        return self.api_client.call_api(
            "/api/service/clients/assets/{assetId}/assetservicerecords",
            "GET",
            _path_params,
            _query_params,
            _header_params,
