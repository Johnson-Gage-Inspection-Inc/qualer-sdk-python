...
class EmployeePreferenceApi(object):
    ...
    def delete_with_http_info(self, element_page, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            "element_page" not in params or params["element_page"] is None
        ):  # noqa: E501
            raise ValueError(
                "Missing the required parameter `element_page` when calling `delete`"
            )  # noqa: E501
    ...
    def get_with_http_info(self, element_page, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `element_page` when calling `get`"
            )  # noqa: E501
