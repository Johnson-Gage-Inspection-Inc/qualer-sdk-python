...
class ServiceOrderDocumentsApi:
    ...
    def _get_document_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/service/workorders/documents/{guid}",
    ...
    def get_document_get_wd(
        ...
        _param = self._get_document_get_wd_serialize(
            guid=guid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_document_get_wd_without_preload_content(
        self,
        guid: Annotated[StrictStr, Field(description="Document unique id")],
        _request_timeout: Union[
            None,
    ...
    def _get_document_get_wd_serialize(
        self,
        guid,
        _request_auth,
        _content_type,
    ...
    def get_document_list(
        ...
        _param = self._get_document_list_serialize(
            var_from=var_from,
            to=to,
    ...
    @validate_call
    def get_document_list_without_preload_content(
        self,
        var_from: Annotated[
            datetime,
            Field(
    ...
    def _get_document_list_serialize(
        self,
        var_from,
        to,
        report_type,
        ...
        if service_order_id is not None:
            ...
            _query_params.append(("serviceOrderId", service_order_id))
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/service/workorders/documents/list",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_documents_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/service/workorders/{serviceOrderId}/documents",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_documents_list(
        ...
        _param = self._get_documents_list_serialize(
            service_order_id=service_order_id,
    ...
    @validate_call
    def get_documents_list_without_preload_content(
        self,
        service_order_id: StrictInt,
        model_report_type: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _get_documents_list_serialize(
        self,
        service_order_id,
        model_report_type,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/service/workorders/{serviceOrderId}/documents/list",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def upload_documents_post2(
        ...
        _param = self._upload_documents_post2_serialize(
            service_order_id=service_order_id,
            model_report_type=model_report_type,
    ...
    @validate_call
    def upload_documents_post2_without_preload_content(
        self,
        service_order_id: StrictInt,
        model_report_type: Optional[StrictStr] = None,
        model_is_private: Optional[StrictBool] = None,
    ...
    def _upload_documents_post2_serialize(
        self,
        service_order_id,
        model_report_type,
        model_is_private,
