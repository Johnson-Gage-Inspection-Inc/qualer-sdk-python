...
class ServiceOrderDocumentsApi(object):
    ...
    def get_document(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_document_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
    ...
    def get_document_list(
        ...
        service_order_id: Annotated[
            Optional[StrictInt],
            Field(
                description="Retrieve documents by given service order id (Optional)"
            ),
        ] = None,
        **kwargs,
    ) -> List[
        ...
        >>> thread = api.get_document_list(var_from, to, report_type, service_order_id, async_req=True)
        >>> result = thread.get()
        ...
        :param service_order_id: Retrieve documents by given service order id (Optional)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: List[QualerApiModelsServiceOrderDocumentsToCompanyOrderControlledDocumentResponse]
        """
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_document_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.get_document_list_with_http_info(
            var_from, to, report_type, service_order_id, **kwargs
        )  # noqa: E501
    ...
    def get_document_list_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.get_document_list_with_http_info(var_from, to, report_type, service_order_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(List[QualerApiModelsServiceOrderDocumentsToCompanyOrderControlledDocumentResponse], status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = ["var_from", "to", "report_type", "service_order_id"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_document_list" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        if _params.get("service_order_id") is not None:  # noqa: E501
            _query_params.append(("serviceOrderId", _params["service_order_id"]))
        ...
        _response_types_map = {
            "200": "List[QualerApiModelsServiceOrderDocumentsToCompanyOrderControlledDocumentResponse]",
            "400": None,
        }
    ...
    def get_documents(
        ...
        **kwargs,
        ...
        >>> thread = api.get_documents(service_order_id, model_file_name, async_req=True)
        >>> result = thread.get()
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_documents_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.get_documents_with_http_info(
            service_order_id, model_file_name, **kwargs
        )  # noqa: E501
    ...
    def get_documents_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.get_documents_with_http_info(service_order_id, model_file_name, async_req=True)
        >>> result = thread.get()
        ...
        _all_params = ["service_order_id", "model_file_name"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
    ...
    def get_documents_list(
        ...
        **kwargs,
        ...
        >>> thread = api.get_documents_list(service_order_id, model_report_type, async_req=True)
        >>> result = thread.get()
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_documents_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.get_documents_list_with_http_info(
            service_order_id, model_report_type, **kwargs
        )  # noqa: E501
    ...
    def get_documents_list_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.get_documents_list_with_http_info(service_order_id, model_report_type, async_req=True)
        >>> result = thread.get()
        ...
        _all_params = ["service_order_id", "model_report_type"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_documents_list" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def upload_documents_post2(
        ...
        **kwargs,
        ...
        """upload_documents_post2  # noqa: E501
        ...
        >>> thread = api.upload_documents_post2(service_order_id, model_report_type, model_is_private, async_req=True)
        >>> result = thread.get()
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the upload_documents_post2_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.upload_documents_post2_with_http_info(
            service_order_id, model_report_type, model_is_private, **kwargs
        )  # noqa: E501
    ...
    def upload_documents_post2_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.upload_documents_post2_with_http_info(service_order_id, model_report_type, model_is_private, async_req=True)
        >>> result = thread.get()
        ...
        _all_params = ["service_order_id", "model_report_type", "model_is_private"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method upload_documents_post2" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
