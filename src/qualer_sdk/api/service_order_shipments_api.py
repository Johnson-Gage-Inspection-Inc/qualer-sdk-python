...
class ServiceOrderShipmentsApi(object):
    ...
    def append_shipment_tracking_number(
        ...
        :param QualerApiModelsServiceOrdersFromAppendTrackingNumberModel model: (required)
        :return: object
        ...
        if kwargs.get("async_req"):
            ...
            (data) = self.append_shipment_tracking_number_with_http_info(
                service_order_id, model, **kwargs
            )  # noqa: E501
            return data
    ...
    def append_shipment_tracking_number_with_http_info(
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `service_order_id` when calling `append_shipment_tracking_number`"
            )  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `model` when calling `append_shipment_tracking_number`"
            )  # noqa: E501
    ...
    def update_shipment_status(self, service_order_id, model, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int service_order_id: (required)
        :param QualerApiModelsServiceOrdersFromUpdateShipmentStatusModel model: (required)
        :return: object
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if kwargs.get("async_req"):
            ...
            (data) = self.update_shipment_status_with_http_info(
                service_order_id, model, **kwargs
            )  # noqa: E501
            return data
    ...
    def update_shipment_status_with_http_info(
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `service_order_id` when calling `update_shipment_status`"
            )  # noqa: E501
        # verify the required parameter 'model' is set
        if self.api_client.client_side_validation and (
            "model" not in params or params["model"] is None
            ...
            raise ValueError(
                "Missing the required parameter `model` when calling `update_shipment_status`"
            )  # noqa: E501
