...
class ClientEmployeesApi(object):
    ...
    def get_employee_with_http_info(self, employee_id, **kwargs):  # noqa: E501
        ...
        if "model_employee_id" in params:
            query_params.append(
                ("model.employeeId", params["model_employee_id"])
            )  # noqa: E501
    ...
    def get_employees(self, client_company_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            ...
            (data) = self.get_employees_with_http_info(
                client_company_id, **kwargs
            )  # noqa: E501
            return data
    ...
    def get_employees_with_http_info(self, client_company_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `client_company_id` when calling `get_employees`"
            )  # noqa: E501
    ...
    def send_employee_email(self, employee_id, model, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            ...
            (data) = self.send_employee_email_with_http_info(
                employee_id, model, **kwargs
            )  # noqa: E501
            return data
    ...
    def send_employee_email_with_http_info(
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `employee_id` when calling `send_employee_email`"
            )  # noqa: E501
        # verify the required parameter 'model' is set
        if self.api_client.client_side_validation and (
            "model" not in params or params["model"] is None
            ...
            raise ValueError(
                "Missing the required parameter `model` when calling `send_employee_email`"
            )  # noqa: E501
