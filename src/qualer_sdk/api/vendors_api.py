...
class VendorsApi(object):
    ...
    def create(self, model, **kwargs):  # noqa: E501
        ...
        :param QualerApiModelsVendorsFromSponsoredVendorCreateModel model: Vendor update model (required)
    ...
    def get_with_http_info(self, vendor_company_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            "vendor_company_id" not in params or params["vendor_company_id"] is None
        ):  # noqa: E501
            raise ValueError(
                "Missing the required parameter `vendor_company_id` when calling `get`"
            )  # noqa: E501
    ...
    def update(self, model, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param QualerApiModelsVendorsFromSponsoredVendorEditModel model: Vendor update model (required)
        :return: object
                 If the method is called asynchronously,
                 returns the request thread.
        """
