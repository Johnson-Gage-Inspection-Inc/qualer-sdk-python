...
class ClientAttributeApi(object):
    ...
    def get_client_attributes(
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_client_attributes_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_client_attributes" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def upsert_client_attribute(
        ...
        **kwargs,
        ...
        :type model: QualerApiModelsClientAttributesFromClientAttributeModel
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the upsert_client_attribute_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method upsert_client_attribute" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
