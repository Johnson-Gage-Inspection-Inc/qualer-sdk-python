...
class CompanyApi(object):
    ...
    def add_department_with_http_info(self, model, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `model` when calling `add_department`"
            )  # noqa: E501
    ...
    def delete_department(self, department_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            ...
            (data) = self.delete_department_with_http_info(
                department_id, **kwargs
            )  # noqa: E501
            return data
    ...
    def delete_department_with_http_info(self, department_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `department_id` when calling `delete_department`"
            )  # noqa: E501
    ...
    def lookups_with_http_info(self, lookup_type, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'" " to method lookups" % key
                )
            params[key] = val
        del params["kwargs"]
        # verify the required parameter 'lookup_type' is set
        if self.api_client.client_side_validation and (
            "lookup_type" not in params or params["lookup_type"] is None
        ):  # noqa: E501
            raise ValueError(
                "Missing the required parameter `lookup_type` when calling `lookups`"
            )  # noqa: E501
    ...
    def site_rooms_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `id` when calling `site_rooms`"
            )  # noqa: E501
    ...
    def sites_with_http_info(self, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'" " to method sites" % key
                )
            params[key] = val
        del params["kwargs"]
    ...
    def update_department(self, department_id, model, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            ...
            (data) = self.update_department_with_http_info(
                department_id, model, **kwargs
            )  # noqa: E501
            return data

    def update_department_with_http_info(
        self, department_id, model, **kwargs
    ):  # noqa: E501
        """# noqa: E501
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `department_id` when calling `update_department`"
            )  # noqa: E501
        # verify the required parameter 'model' is set
        if self.api_client.client_side_validation and (
            "model" not in params or params["model"] is None
            ...
            raise ValueError(
                "Missing the required parameter `model` when calling `update_department`"
            )  # noqa: E501
