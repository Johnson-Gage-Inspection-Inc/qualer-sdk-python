...
class ServicePricingApi:
    ...
    def get_get7(
        ...
        _param = self._get_get7_serialize(
    ...
    @validate_call
    def get_get7_without_preload_content(
        self,
        service_pricing_id: StrictInt,
        service_group_id: Annotated[
            Optional[StrictInt], Field(description="optional")
    ...
    def _get_get7_serialize(
        ...
        if service_pricing_id is not None:
            ...
            _query_params.append(("servicePricingId", service_pricing_id))

        if service_group_id is not None:

            _query_params.append(("serviceGroupId", service_group_id))
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/service/pricing",
    ...
    def update_put3(
        ...
        _param = self._update_put3_serialize(
            models=models,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def update_put3_without_preload_content(
        self,
        models: List[
            QualerWebMvcAreasApiModelsServicePricesFromServicePriceBulkEditModel
        ],
