...
class ServicePricingApi(object):
    ...
    def get_with_http_info(self, service_pricing_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            "service_pricing_id" not in params or params["service_pricing_id"] is None
        ):  # noqa: E501
            raise ValueError(
                "Missing the required parameter `service_pricing_id` when calling `get`"
            )  # noqa: E501
        ...
        if "service_pricing_id" in params:
            query_params.append(
                ("servicePricingId", params["service_pricing_id"])
            )  # noqa: E501
    ...
    def update(self, models, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param list[QualerWebMvcAreasApiModelsServicePricesFromServicePriceBulkEditModel] models: (required)
        :return: list[QualerApiModelsServiceOrdersToServiceOrderTaskResponse]
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def update_with_http_info(self, models, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `models` when calling `update`"
            )  # noqa: E501
