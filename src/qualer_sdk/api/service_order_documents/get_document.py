...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/service/workorders/documents/{guid}",
    }
...
) -> Optional[Union[Any, GetDocumentResponse200]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetDocumentResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, GetDocumentResponse200]
    """
