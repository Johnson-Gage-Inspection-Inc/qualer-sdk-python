...
class AssetReservationApi(object):
    ...
    def close_with_http_info(self, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'" " to method close" % key
                )
            params[key] = val
        del params["kwargs"]
        ...
        if "model_product_id" in params:
            query_params.append(
                ("model.productId", params["model_product_id"])
            )  # noqa: E501
        ...
        if "model_asset_tag" in params:
            query_params.append(
                ("model.assetTag", params["model_asset_tag"])
            )  # noqa: E501
        if "model_reservation_id" in params:
            query_params.append(
                ("model.reservationId", params["model_reservation_id"])
            )  # noqa: E501
    ...
    def upsert_with_http_info(self, model, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'" " to method upsert" % key
                )
            params[key] = val
        del params["kwargs"]
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `model` when calling `upsert`"
            )  # noqa: E501
