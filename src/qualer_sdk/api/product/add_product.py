...
from ...models.add_product_response_200 import AddProductResponse200
...
) -> Optional[AddProductResponse200]:
    if response.status_code == 200:
        response_200 = AddProductResponse200.from_dict(response.json())
