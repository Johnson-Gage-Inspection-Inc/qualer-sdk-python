...
class ServiceOrderPaymentsApi(object):
    ...
    def change_work_order_payment_status(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the change_work_order_payment_status_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.change_work_order_payment_status_with_http_info(
    ...
    def change_work_order_payment_status_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method change_work_order_payment_status" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        return self.api_client.call_api(
            "/api/service/workorders/{serviceOrderId}/payments/status",
            "PUT",
            _path_params,
            _query_params,
            _header_params,
    ...
    def create_work_order_payment(
        ...
        **kwargs,
    ) -> QualerApiModelsServiceOrdersToCreatedWorkOrderPaymentResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: QualerApiModelsServiceOrdersToCreatedWorkOrderPaymentResponse
        """
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the create_work_order_payment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.create_work_order_payment_with_http_info(
            service_order_id, model, **kwargs
        )  # noqa: E501
    ...
    def create_work_order_payment_with_http_info(
        ...
        **kwargs,
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(QualerApiModelsServiceOrdersToCreatedWorkOrderPaymentResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_work_order_payment" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        return self.api_client.call_api(
            "/api/service/workorders/{serviceOrderId}/payments",
            "POST",
            _path_params,
            _query_params,
            _header_params,
    ...
    def get_all_work_order_payments(
    ...
    ) -> List[QualerApiModelsServiceOrdersToPaymentResponseModel]:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: List[QualerApiModelsServiceOrdersToPaymentResponseModel]
        """
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_all_work_order_payments_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.get_all_work_order_payments_with_http_info(
    ...
    def get_all_work_order_payments_with_http_info(
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(List[QualerApiModelsServiceOrdersToPaymentResponseModel], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_work_order_payments" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def get_work_order_payment(
    ...
    ) -> QualerApiModelsServiceOrdersToPaymentResponseModel:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: QualerApiModelsServiceOrdersToPaymentResponseModel
        """
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_work_order_payment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.get_work_order_payment_with_http_info(
            service_order_payment_id, **kwargs
        )  # noqa: E501
    ...
    def get_work_order_payment_with_http_info(
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(QualerApiModelsServiceOrdersToPaymentResponseModel, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = ["service_order_payment_id"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_work_order_payment" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        # process the path parameters
        _path_params = {}
        if _params["service_order_payment_id"]:
            _path_params["serviceOrderPaymentId"] = _params["service_order_payment_id"]
        ...
        return self.api_client.call_api(
            "/api/service/workorders/payments/{serviceOrderPaymentId}",
            "GET",
            _path_params,
            _query_params,
            _header_params,
