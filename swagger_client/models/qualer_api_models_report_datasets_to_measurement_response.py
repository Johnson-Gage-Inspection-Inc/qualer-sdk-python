...
class QualerApiModelsReportDatasetsToMeasurementResponse(object):
    ...
    def __init__(self, is_accredited=None, service_total=None, repairs_total=None, parts_total=None, parameter_id=None, tool_range_name=None, tool_range_uncertainty=None, primary_tool_last_service_date=None, primary_tool_next_service_date=None, primary_tool_calibrated_by=None, primary_tool_tool_name=None, primary_tool_tool_description=None, primary_tool_tool_type_name=None, primary_tool_manufacturer=None, primary_tool_manufacturer_part_number=None, primary_tool_serial_number=None, secondary_tool_last_service_date=None, secondary_tool_next_service_date=None, secondary_tool_calibrated_by=None, secondary_tool_tool_name=None, secondary_tool_tool_description=None, secondary_tool_tool_type_name=None, secondary_tool_manufacturer=None, secondary_tool_manufacturer_part_number=None, secondary_tool_serial_number=None, measurement_set_name=None, decimal_places=None, significant_figures=None, sd_header=None, cv_header=None, measurement_local_time=None, mean=None, mean_raw=None, mean_decimal_places=None, mean_extended=None, sd=None, sd_raw=None, sd_decimal_places=None, delta=None, range=None, sd_extended=None, range_extended=None, delta_extended=None, minimum_measured_value=None, maximum_measured_value=None, min_max_value_extended=None, cv=None, cv_raw=None, cv_decimal_places=None, cv_extended=None, result=None, range_result=None, delta_result=None, min_result=None, max_result=None, tar_result=None, tur_result=None, error_result=None, sd_result=None, cv_result=None, custom_field_result=None, mu=None, mu_raw=None, mu_effective_dof=None, mu_coverage_factor=None, mu_extended=None, cmc=None, cmc_comments=None, tur=None, tur_raw=None, tur_decimal_places=None, tar=None, tar_raw=None, tar_decimal_places=None, guard_band=None, guard_band_logic=None, uncertainty_budget=None, calculated_uncertainty=None, lock_uncertainty_budget=None, lab_mu=None, channel=None, measurement_type=None, updated_by=None, updated_on=None, error=None, error_extended=None, require_adjustment=None, adjustment_threshold=None, percent_of_tolerance=None, percent_of_tolerance_extended=None, tol_decimal_places=None, specification_title=None, specification_subtitle=None, specification_group=None, batch_type=None, batch_result=None, is_by_channel=None, channel_count=None, is_range_accredited=None, commenced_on=None, commenced_by=None, z_factor=None, air_buoyancy=None, evaporation_rate=None, air_humidity=None, altitude=None, ambient_temperature=None, barometric_pressure=None, light_intensity=None, noise_level=None, ph_level=None, water_conductivity=None, water_temperature=None, solar_radiation=None, wind_speed=None, z_factor_uom=None, air_buoyancy_uom=None, evaporation_rate_uom=None, air_humidity_uom=None, altitude_uom=None, ambient_temperature_uom=None, barometric_pressure_uom=None, light_intensity_uom=None, noise_level_uom=None, ph_level_uom=None, water_conductivity_uom=None, water_temperature_uom=None, solar_radiation_uom=None, wind_speed_uom=None, specification_name=None, parameter_name=None, measurement_set_display_order=None, display_order=None, unit_of_measure=None, display_format=None, precision=None, minimum=None, nominal=None, expected_value=None, expected_value_raw=None, test_value=None, base_value=None, use_expected_value=None, reading_entry_logic=None, reading_entry_math=None, double_substitution_sequence=None, reading_entry_math_string=None, nominal_extended=None, expected_value_extended=None, maximum=None, tolerance_min=None, tolerance_max=None, resolution=None, resolution_count=None, min_max_header=None, accuracy_class=None, accuracy_class_min=None, accuracy_class_max=None, environment_mask=None, display_name=None, display_part_number=None, part_number=None, vendor_company_id=None, service_order_number=None, custom_order_number=None, completed_by_name=None, completed_on=None, is_limited=None, vendor_tag=None, vendor_service_notes=None, room=None, segment_name=None, schedule_name=None, next_segment_name=None, certificate_number=None, work_status=None, service_type=None, service_level=None, barcode=None, service_comments=None, order_item_number=None, asset_tag=None, asset_user=None, serial_number=None, equipment_id=None, legacy_identifier=None, site_name=None, asset_name=None, asset_description=None, product_name=None, product_description=None, asset_maker=None, station=None, asset_tag_change=None, asset_user_change=None, serial_number_change=None, service_date=None, next_service_date=None, service_order_item_id=None, service_order_id=None, measurement_batch_id=None, measurement_id=None, standard_id=None, tool_id=None, measurement_tool_id=None, measurement_condition_id=None, measurement_point_id=None, measurement_set_id=None, is_hidden=None, readings=None, tolerance_type=None, tolerance_type_string=None, precision_type=None, specification_mode=None, tolerance_mode=None, tolerance_unit=None, tolerance_string=None, po_number=None, secondary_po=None, shipped_date=None, shipment_status=None, shipped_on=None, delivered_on=None, tracking_number=None, payment_terms=None, shipping_method=None, location=None, site_access_notes=None, abbreviated_uom=None, unit_scale_factor=None, measurement_not_taken_result=None, hide_from_certificate=None, measurement_not_taken_reason=None, environment_text1=None, environment_text2=None, environment_text3=None, environment_text4=None, environment_text5=None, environment_text6=None, values=None, value1=None, value2=None, value3=None, value4=None, value5=None, value6=None, value7=None, value8=None, value9=None, value10=None, value11=None, value12=None, value13=None, value14=None, value15=None, value16=None, value17=None, value18=None, value19=None, value20=None, value21=None, value22=None, value23=None, value24=None, value25=None, value26=None, value27=None, value28=None, value29=None, value30=None, value31=None, value32=None, value33=None, value34=None, value35=None, value36=None, value37=None, value38=None, value39=None, value40=None, raw_value1=None, raw_value2=None, raw_value3=None, raw_value4=None, raw_value5=None, raw_value6=None, raw_value7=None, raw_value8=None, raw_value9=None, raw_value10=None, raw_value11=None, raw_value12=None, raw_value13=None, raw_value14=None, raw_value15=None, raw_value16=None, raw_value17=None, raw_value18=None, raw_value19=None, raw_value20=None, raw_value21=None, raw_value22=None, raw_value23=None, raw_value24=None, raw_value25=None, raw_value26=None, raw_value27=None, raw_value28=None, raw_value29=None, raw_value30=None, raw_value31=None, raw_value32=None, raw_value33=None, raw_value34=None, raw_value35=None, raw_value36=None, raw_value37=None, raw_value38=None, raw_value39=None, raw_value40=None, subtitles_to_readings=None, value_subtitle1=None, value_subtitle2=None, value_subtitle3=None, value_subtitle4=None, value_subtitle5=None, value_subtitle6=None, value_subtitle7=None, value_subtitle8=None, value_subtitle9=None, value_subtitle10=None, value_subtitle11=None, value_subtitle12=None, value_subtitle13=None, value_subtitle14=None, value_subtitle15=None, value_subtitle16=None, value_subtitle17=None, value_subtitle18=None, value_subtitle19=None, value_subtitle20=None, value_subtitle21=None, value_subtitle22=None, value_subtitle23=None, value_subtitle24=None, value_subtitle25=None, value_subtitle26=None, value_subtitle27=None, value_subtitle28=None, value_subtitle29=None, value_subtitle30=None, value_subtitle31=None, value_subtitle32=None, value_subtitle33=None, value_subtitle34=None, value_subtitle35=None, value_subtitle36=None, value_subtitle37=None, value_subtitle38=None, value_subtitle39=None, value_subtitle40=None, values_decimal_places=None, repeat_measurement_and_calculate_hysteresis=None, measurement_point_order=None, hysteresis_point=None, max_hysteresis=None, run=None, direction=None, hysteresis=None, column_mean=None, column_mean_result=None, column_sd=None, column_sd_result=None, column_cv=None, column_cv_result=None, column_range=None, column_range_result=None, column_delta=None, column_delta_result=None, column_result=None):  # noqa: E501
        ...
        if primary_tool_manufacturer_part_number is not None:
            self.primary_tool_manufacturer_part_number = primary_tool_manufacturer_part_number
        ...
        if secondary_tool_manufacturer_part_number is not None:
            self.secondary_tool_manufacturer_part_number = secondary_tool_manufacturer_part_number
        ...
        if repeat_measurement_and_calculate_hysteresis is not None:
            self.repeat_measurement_and_calculate_hysteresis = repeat_measurement_and_calculate_hysteresis
    ...
    def primary_tool_manufacturer_part_number(self, primary_tool_manufacturer_part_number):
        ...
        self._primary_tool_manufacturer_part_number = primary_tool_manufacturer_part_number
    ...
    def secondary_tool_manufacturer_part_number(self, secondary_tool_manufacturer_part_number):
        ...
        self._secondary_tool_manufacturer_part_number = secondary_tool_manufacturer_part_number
    ...
    def guard_band_logic(self, guard_band_logic):
        ...
        if guard_band_logic not in allowed_values:
            raise ValueError(
                "Invalid value for `guard_band_logic` ({0}), must be one of {1}"  # noqa: E501
                .format(guard_band_logic, allowed_values)
            )
    ...
    def reading_entry_logic(self, reading_entry_logic):
        ...
        :type: str
        """
        allowed_values = ["SingleValue", "TwoValues", "TwoValuesAndResult", "MeasuredValueConversion", "MeasuredValueConversionDisplay", "DoubleSubstitution"]  # noqa: E501
        if reading_entry_logic not in allowed_values:
            raise ValueError(
                "Invalid value for `reading_entry_logic` ({0}), must be one of {1}"  # noqa: E501
                .format(reading_entry_logic, allowed_values)
            )
    ...
    def reading_entry_math(self, reading_entry_math):
        ...
        if reading_entry_math not in allowed_values:
            raise ValueError(
                "Invalid value for `reading_entry_math` ({0}), must be one of {1}"  # noqa: E501
                .format(reading_entry_math, allowed_values)
            )
    ...
    def double_substitution_sequence(self, double_substitution_sequence):
        ...
        :type: str
        """
        allowed_values = ["ZeroStandard", "StandardTested", "TestedStandard"]  # noqa: E501
        if double_substitution_sequence not in allowed_values:
            raise ValueError(
                "Invalid value for `double_substitution_sequence` ({0}), must be one of {1}"  # noqa: E501
                .format(double_substitution_sequence, allowed_values)
            )
    ...
    def environment_mask(self, environment_mask):
        ...
        if environment_mask not in allowed_values:
            raise ValueError(
                "Invalid value for `environment_mask` ({0}), must be one of {1}"  # noqa: E501
                .format(environment_mask, allowed_values)
            )
    ...
    def tolerance_type(self, tolerance_type):
        ...
        :type: str
        """
        allowed_values = ["Percentage", "Range", "Offset", "PercentagePlus", "Ppm", "PpmPlus", "Function"]  # noqa: E501
        if tolerance_type not in allowed_values:
            raise ValueError(
                "Invalid value for `tolerance_type` ({0}), must be one of {1}"  # noqa: E501
                .format(tolerance_type, allowed_values)
            )
    ...
    def precision_type(self, precision_type):
        ...
        if precision_type not in allowed_values:
            raise ValueError(
                "Invalid value for `precision_type` ({0}), must be one of {1}"  # noqa: E501
                .format(precision_type, allowed_values)
            )
    ...
    def specification_mode(self, specification_mode):
        ...
        if specification_mode not in allowed_values:
            raise ValueError(
    ...
    def tolerance_mode(self, tolerance_mode):
        ...
        if tolerance_mode not in allowed_values:
            raise ValueError(
    ...
    def tolerance_unit(self, tolerance_unit):
        ...
        if tolerance_unit not in allowed_values:
            raise ValueError(
    ...
    def shipment_status(self, shipment_status):
        ...
        :type: str
        """
        allowed_values = ["NotShipped", "PartialShipment", "Shipped", "Delivered", "OnSite"]  # noqa: E501
    ...
    def measurement_not_taken_result(self, measurement_not_taken_result):
        ...
        if measurement_not_taken_result not in allowed_values:
            raise ValueError(
                "Invalid value for `measurement_not_taken_result` ({0}), must be one of {1}"  # noqa: E501
                .format(measurement_not_taken_result, allowed_values)
            )
    ...
    def repeat_measurement_and_calculate_hysteresis(self, repeat_measurement_and_calculate_hysteresis):
        ...
        self._repeat_measurement_and_calculate_hysteresis = repeat_measurement_and_calculate_hysteresis
    ...
    def measurement_point_order(self, measurement_point_order):
        ...
        :type: str
        """
        allowed_values = ["AsEntered", "DescendingAscending", "AscendingDescending", "ZeroDescendingAscending", "ZeroAscendingDescending"]  # noqa: E501
        if measurement_point_order not in allowed_values:
            raise ValueError(
                "Invalid value for `measurement_point_order` ({0}), must be one of {1}"  # noqa: E501
                .format(measurement_point_order, allowed_values)
            )
    ...
    def hysteresis_point(self, hysteresis_point):
        ...
        if hysteresis_point not in allowed_values:
            raise ValueError(
