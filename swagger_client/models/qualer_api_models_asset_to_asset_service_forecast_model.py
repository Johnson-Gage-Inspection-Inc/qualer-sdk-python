...
class QualerApiModelsAssetToAssetServiceForecastModel(object):
    ...
    def __init__(self, company_id=None, asset_id=None, site_id=None, asset_service_record_id=None, serial_number=None, asset_user=None, asset_tag=None, equipment_id=None, asset_name=None, category_name=None, manufacturer_name=None, site_name=None, maintenance_plan_id=None, maintenance_plan_name=None, maintenance_task_id=None, maintenance_task_name=None, next_service_date=None, advance_recall_date=None, grace_period_date=None, certificate_next_service_date=None, service_interval=None, interval_cycle=None, interval_length=None, on_day=None, on_month=None, on_week_days=None, weekday_of_month=None, advance_recall_period=None, days_before_due=None, past_due_grace_period=None, days_after_due=None):  # noqa: E501
    ...
    def on_day(self, on_day):
        ...
        :type: str
        """
        allowed_values = ["Day1", "Day2", "Day3", "Day4", "Day5", "Day6", "Day7", "Day8", "Day9", "Day10", "Day11", "Day12", "Day13", "Day14", "Day15", "Day16", "Day17", "Day18", "Day19", "Day20", "Day21", "Day22", "Day23", "Day24", "Day25", "Day26", "Day27", "Day28", "Day29", "Day30", "Day31", "First", "Second", "Third", "Fourth", "Last"]  # noqa: E501
        if on_day not in allowed_values:
            raise ValueError(
                "Invalid value for `on_day` ({0}), must be one of {1}"  # noqa: E501
                .format(on_day, allowed_values)
            )
    ...
    def on_month(self, on_month):
        ...
        :type: str
        """
        allowed_values = ["None", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December", "All"]  # noqa: E501
        if on_month not in allowed_values:
            raise ValueError(
                "Invalid value for `on_month` ({0}), must be one of {1}"  # noqa: E501
                .format(on_month, allowed_values)
            )
    ...
    def on_week_days(self, on_week_days):
        ...
        :type: str
        """
        allowed_values = ["None", "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "WeekendDays", "WorkDays", "EveryDay"]  # noqa: E501
        if on_week_days not in allowed_values:
            raise ValueError(
                "Invalid value for `on_week_days` ({0}), must be one of {1}"  # noqa: E501
                .format(on_week_days, allowed_values)
            )
    ...
    def weekday_of_month(self, weekday_of_month):
        ...
        if weekday_of_month not in allowed_values:
            raise ValueError(
                "Invalid value for `weekday_of_month` ({0}), must be one of {1}"  # noqa: E501
                .format(weekday_of_month, allowed_values)
            )
