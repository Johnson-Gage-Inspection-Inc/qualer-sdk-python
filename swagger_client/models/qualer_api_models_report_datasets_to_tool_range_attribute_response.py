...
class QualerApiModelsReportDatasetsToToolRangeAttributeResponse(object):
    ...
    def __init__(self, measurement_point_id=None, service_order_item_id=None, tool_id=None, range_title=None, range_subtitle=None, attribute_name=None, attribute_value=None):  # noqa: E501
