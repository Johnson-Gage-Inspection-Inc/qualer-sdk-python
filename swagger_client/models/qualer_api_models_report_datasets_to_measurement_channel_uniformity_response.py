...
class QualerApiModelsReportDatasetsToMeasurementChannelUniformityResponse(object):
    ...
    def __init__(self, service_order_item_id=None, measurement_point_id=None, batch_type=None, column_index=None, mean=None, mean_result=None, sd=None, sd_result=None, cv=None, cv_result=None, range=None, range_result=None, delta=None, delta_result=None, result=None):  # noqa: E501
