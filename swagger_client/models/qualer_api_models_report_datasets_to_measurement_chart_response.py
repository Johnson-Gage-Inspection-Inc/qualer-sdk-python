...
class QualerApiModelsReportDatasetsToMeasurementChartResponse(object):
    ...
    def __init__(self, service_order_item_id=None, measurement_set_id=None, chart_type=None, chart_image=None, nominal=None, title=None, unit_of_measure=None, abbreviated_uom=None):  # noqa: E501
